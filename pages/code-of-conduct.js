...
export default function CodeOfConduct({ contentHtml, frontMatter }) {
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: frontMatter.title,
          description: frontMatter.description,
          url: "https://theclaw.team/code-of-conduct",
...
export async function getStaticProps() {
  const fileContents = fs.readFileSync("./data/code-of-conduct.md", "utf-8");
